...
public class displayReviewsAdapter extends RecyclerView.Adapter<displayReviewsAdapter.mViewHolder>{
    ...
    public displayReviewsAdapter(List<displayReviews> displayReviewsList) {
    ...
    public void onBindViewHolder(mViewHolder holder, int position) {
        ...
        holder.reviewTime.setText(convertTime(entry.getReviewTime()));
