...
public class displayFavBasicsAdapter extends RecyclerView.Adapter<displayFavBasicsAdapter.mViewHolder> {
    ...
    public displayFavBasicsAdapter(List<displayBasics> list, Context context) {
